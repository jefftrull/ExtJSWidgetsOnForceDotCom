...
Ext you are actually using.  At this time only ExtJS versions 3.X are supported.

The resource I tested with most recently consists of the Ext 3.4.0 release, as downloaded from:
...
which are needed for the grids.  The resulting file is a little over 5MB.
